...
class RAGHelper:
    ...
    def loadData(self):
        ...
        if os.getenv("vector_store") == "postgres":
            ...
            self.sparse_retriever = PostgresBM25Retriever(connection_uri=vector_store_sparse_uri,
            ...
            raise Exception(
                "Only milvus or postgres are supported as vector stores! Please set vector_store in your .env file.")
