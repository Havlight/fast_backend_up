...
I currently add fastapi and markdown support.
there is more need to be added
...
below is Configuration almost from RAGMEUP but I also make a little changes
# Configuration
...
- `embedding_provider` specify the provider of embedding model support olllama、jina、HuggingFace
